...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    const {
      ...
      phone_number,
      zipcode,
    } = formData; /* use destructuring to assign names to 
    ...
    const passwordRegex =
      /^(?=.*[0-9])(?=.*[!@#$%^&*])[A-Za-z0-9!@#$%^&*]{8,}$/; //minimum 8 chars, 1 special char, 1 number
    ...
    if (
      ...
      setError(
        'Password must have a minimum of 8 characters, 1 special character, and 1 number'
      );
      return;
          ...
          <div className="checkbox-content">
            ...
            <label className="checks">
              <input
                ...
                onChange={handleChange}
                checked={
                  formData.ethnicity === 'Middle Eastern or North African'
                }
